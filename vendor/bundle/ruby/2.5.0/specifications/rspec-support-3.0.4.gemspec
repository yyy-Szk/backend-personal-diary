# -*- encoding: utf-8 -*-
# stub: rspec-support 3.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-support-3.0.4".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec>.freeze, [">= 3.0.0.pre"])
    else
      s.add_dependency(%q<bundler>.freeze, ["~> 1.3"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0.0"])
      s.add_dependency(%q<rspec>.freeze, [">= 3.0.0.pre"])
    end
  else
    s.add_dependency(%q<bundler>.freeze, ["~> 1.3"])
    s.add_dependency(%q<rake>.freeze, ["~> 10.0.0"])
