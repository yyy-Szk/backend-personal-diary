...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-rails-3.0.2".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.0.0"])
      ...
      s.add_development_dependency(%q<ammeter>.freeze, ["= 1.0.0"])
    else
      ...
      s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.0.0"])
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.0.0"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0.0"])
      s.add_dependency(%q<cucumber>.freeze, ["~> 1.3.5"])
      s.add_dependency(%q<aruba>.freeze, ["~> 0.5.4"])
      s.add_dependency(%q<ammeter>.freeze, ["= 1.0.0"])
    end
  else
    s.add_dependency(%q<activesupport>.freeze, [">= 3.0"])
    s.add_dependency(%q<actionpack>.freeze, [">= 3.0"])
